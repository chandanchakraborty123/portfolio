        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 rounded-2xl p-6 md:p-8 backdrop-blur-sm hover:border-blue-500/30 transition-all duration-300 group">
              <div className="flex items-start gap-4 mb-6">
                <div className="p-3 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-xl group-hover:scale-110 transition-transform duration-300">
                  <i className="bi bi-person-badge text-3xl text-blue-400" />
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-white mb-2">Who I Am</h3>
                  <div className="w-12 h-0.5 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full" />
                </div>
              </div>
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                I have worked on <span className="text-blue-400 font-semibold">AI-powered platforms</span>,{" "}
              ...
              <p className="text-gray-300 leading-relaxed">
                My goal is to contribute to <span className="text-blue-400 font-semibold">impactful remote projects</span> while
            ...
            <div className="grid grid-cols-2 gap-4">
              {achievements.map((item, index) => (
                ...
                >
                  <i className={`${item.icon} text-3xl text-blue-400 mb-2 inline-block group-hover:scale-110 transition-transform`} />
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 rounded-2xl p-6 md:p-8 backdrop-blur-sm hover:border-blue-500/30 transition-all duration-300">
              <div className="flex items-start gap-4 mb-6">
                <div className="p-3 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-xl">
                  <i className="bi bi-code-slash text-3xl text-cyan-400" />
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-white mb-2">Technical Skills</h3>
                  <div className="w-12 h-0.5 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full" />
                </div>
              </div>
                  ...
                  <div key={index} className="group">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        <i className={`${skill.icon} text-blue-400 text-lg`} />
            ...
            <div className="bg-gradient-to-r from-blue-600/10 to-cyan-600/10 border border-blue-500/30 rounded-xl p-6 text-center hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300">
              <i className="bi bi-envelope-paper text-3xl text-blue-400 mb-1 inline-block" />
              ...
              <a
                href="#contact"
                className="btn-keep-white inline-block px-6 py-2 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-lg hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300 transform hover:scale-105"
              >
                Get in Touch
