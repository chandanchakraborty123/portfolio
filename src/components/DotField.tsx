  ...
  ({
    ...
    useEffect(() => {
      ...
      function doResize() {
        ...
        const rect = surface.parentElement.getBoundingClientRect();
        const w = rect.width;
        const h = rect.height;
      ...
      function tick() {
        ...
        const grad = draw.createLinearGradient(0, 0, w, h);
        ...
        for (let i = 0; i < len; i++) {
          ...
          if (p.sparkle) {
            ...
            if (hash % 100 < 3) {
              draw.moveTo(drawX + rad * 1.8, drawY);
              draw.arc(drawX, drawY, rad * 1.8, 0, TWO_PI);
            } else {
              draw.moveTo(drawX + rad, drawY);
              draw.arc(drawX, drawY, rad, 0, TWO_PI);
            }
          } else {
            draw.moveTo(drawX + rad, drawY);
            draw.arc(drawX, drawY, rad, 0, TWO_PI);
