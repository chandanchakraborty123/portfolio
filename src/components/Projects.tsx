    ...
    const data = [
      {
        ...
        description:
          "AI-powered recruitment and resume builder platform with modern UI and seamless API integration.",
        icon: "🤖",
        link: "https://www.talentfitai.com/",
        tech: ["React JS", "TypeScript", "Redux Toolkit", "REST API"],
        title: "TalentFit AI",
      },
      {
        _id: "69bd7a0047b3957240930480",
        description:
          "Official website for Telangana American Telugu Association with Instagram API integration.",
        icon: "🌐",
        link: "",
      ...
      },
      {
        ...
        description:
          "Lalit Tutorials is a coaching institute for NEET and JEE preparation. It provides expert guidance, study materials, and test series for students.",
        icon: "📚",
              ...
              >
                ...
                {project.link && (
                  <a
                    ...
                    className="btn-keep-white inline-block w-full text-center px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300 group-hover:to-cyan-600"
                  >
                    View Project →
                  </a>
                )}
