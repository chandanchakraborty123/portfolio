...
const Threads = ({
  ...
  useEffect(() => {
    ...
    function update(t: number) {
      ...
      const { color: threadColor, amplitude: threadAmplitude, distance: threadDistance, enableMouseInteraction: mouseEnabled } =
        propsRef.current;

      program.uniforms.uColor.value.set(...threadColor);
      program.uniforms.uAmplitude.value = threadAmplitude;
      program.uniforms.uDistance.value = threadDistance;
